...
import { RESPONSE_CODES, ROLE_IDS } from "../../config/constants.js";
...
class DashboardRoutes {
    ...
    getDashboardCountAll = async (req) => {
        let retObj = {};
        if (req.user.data.role_id._id != ROLE_IDS.ADMIN) {
            retObj = {
        ...
        const totalExpert = await dashboardService.getTotalExpertPerformer({ role_id: ROLE_IDS.USER, is_deleted: false, status: 'Active' })
